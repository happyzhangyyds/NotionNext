  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={
          'rounded-xl overflow-hidden opacity-0 group-hover:opacity-100 duration-300 transition-all bg-[#C7EDCC] dark:bg-[#C7EDCC] dark:text-white cursor-pointer absolute w-full h-full top-0 flex justify-start items-center'
        }
      >
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "url('https://bu.dusays.com/2024/03/23/65fe9b27e47ab.webp') no-repeat center /cover"
          }}
        ></div>
      </div>
    </div>
