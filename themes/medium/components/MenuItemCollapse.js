...
export const MenuItemCollapse = (props) => {
  ...
  return <>
        <div className={ (selected ? 'bg-red-400 text-white hover:text-white' : 'hover:text-red-400') + ' px-5 w-full text-left duration-200 dark:bg-hexo-black-gray dark:border-black'} onClick={toggleShow} >
