...
const BlogPostCard = ({ post, showSummary }) => {
  ...
  return (
        ...
        >
            ...
            passHref
            className={
             'cursor-pointer font-bold text-2xl leading-tight text-gray-700'
              }>
             <h2>
                        ...
                        <div className="pointer-events-none border-t pt-8 border-dashed">
                            <div className="w-full justify-start flex">
                                <Link
                                    href={url}
                                    passHref
                                    className="hover:bg-opacity-100 hover:scale-105 duration-200 pointer-events-auto transform font-bold text-yellow-500 cursor-pointer">
