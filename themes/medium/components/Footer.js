...
const Footer = ({ title }) => {
  ...
  return (
    ...
    >
       <DarkModeButton/>
      <i className='fas fa-copyright'  /> {`${copyrightDate}`} <span><i className='mx-1 animate-pulse fas fa-heart'  style={{ color: "LightPink" }} /><a href={BLOG.LINK} className='underline font-bold text-black-300 dark:text-black-300 '>{BLOG.AUTHOR}</a>.<br/>
