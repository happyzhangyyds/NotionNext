...
const SearchInput = ({ currentTag, currentSearch, cRef, className }) => {
  ...
  return <div className={'flex w-full bg-gray-100 ' + className}>
    <input
      ref={searchInputRef}
      type='text'
      className={'outline-none w-full text-sm pl-2 transition focus:shadow-lg font-light leading-10 text-black bg-orange-100 dark:bg-stone-950 dark:text-white'}
      onKeyUp={handleKeyUp}
