...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'MatrixCore&微风起', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '不是一座孤岛，而是与挚友风雨兼程', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://matrixcore.life', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '微风起，Notion, MatrixCore,matrixcore,MatrixCore的博客,NotionNext,博客,学习分享,生活体验,Elog', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '开往20270420', // 备案号 闽ICP备XXXXXXX
