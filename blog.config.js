...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, MatrixCore,matrixcore,MatrixCore的博客,NotionNext,博客,学习分享,生活体验,Elog+Notion', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20270420号', // 备案号 闽ICP备XXXXXXX
